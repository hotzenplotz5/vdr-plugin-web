...
void swap(ProcessOsdUpdateType &a, ProcessOsdUpdateType &b) noexcept {
  using ::std::swap;
...
void swap(ProcessOsdUpdateQOIType &a, ProcessOsdUpdateQOIType &b) noexcept {
  using ::std::swap;
...
void swap(ProcessTSPacketType &a, ProcessTSPacketType &b) noexcept {
  using ::std::swap;
  swap(a.ts, b.ts);
  swap(a.__isset, b.__isset);
}
...
void swap(StartVideoType &a, StartVideoType &b) noexcept {
  using ::std::swap;
...
void swap(VideoSizeType &a, VideoSizeType &b) noexcept {
  using ::std::swap;
  swap(a.x, b.x);
  swap(a.y, b.y);
  swap(a.w, b.w);
...
void swap(ResetVideoType &a, ResetVideoType &b) noexcept {
  using ::std::swap;
  swap(a.videoInfo, b.videoInfo);
  swap(a.__isset, b.__isset);
}
...
void swap(SelectAudioTrackType &a, SelectAudioTrackType &b) noexcept {
  using ::std::swap;
