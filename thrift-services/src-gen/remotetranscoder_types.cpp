...
void swap(ProbeType &a, ProbeType &b) noexcept {
  using ::std::swap;
  swap(a.url, b.url);
...
void swap(StreamUrlType &a, StreamUrlType &b) noexcept {
  using ::std::swap;
  swap(a.url, b.url);
  swap(a.cookies, b.cookies);
  swap(a.referer, b.referer);
...
void swap(PauseType &a, PauseType &b) noexcept {
  using ::std::swap;
...
void swap(SeekToType &a, SeekToType &b) noexcept {
  using ::std::swap;
  swap(a.streamId, b.streamId);
...
void swap(ResumeType &a, ResumeType &b) noexcept {
  using ::std::swap;
  swap(a.streamId, b.streamId);
...
void swap(StopType &a, StopType &b) noexcept {
  using ::std::swap;
  swap(a.streamId, b.streamId);
...
void swap(AudioInfoType &a, AudioInfoType &b) noexcept {
  using ::std::swap;
  swap(a.streamId, b.streamId);
  swap(a.__isset, b.__isset);
}
...
void swap(VideoType &a, VideoType &b) noexcept {
  using ::std::swap;
