...
void swap(LoadUrlType &a, LoadUrlType &b) noexcept {
  using ::std::swap;
  swap(a.url, b.url);
...
void swap(RedButtonType &a, RedButtonType &b) noexcept {
  using ::std::swap;
...
void swap(StartApplicationType &a, StartApplicationType &b) noexcept {
  using ::std::swap;
  swap(a.channelId, b.channelId);
...
void swap(ProcessKeyType &a, ProcessKeyType &b) noexcept {
  using ::std::swap;
  swap(a.key, b.key);
  swap(a.__isset, b.__isset);
}
...
void swap(StreamErrorType &a, StreamErrorType &b) noexcept {
  using ::std::swap;
...
void swap(InsertHbbtvType &a, InsertHbbtvType &b) noexcept {
  using ::std::swap;
...
void swap(InsertChannelType &a, InsertChannelType &b) noexcept {
  using ::std::swap;
...
void swap(StopVideoType &a, StopVideoType &b) noexcept {
  using ::std::swap;
  swap(a.reason, b.reason);
  swap(a.__isset, b.__isset);
}
